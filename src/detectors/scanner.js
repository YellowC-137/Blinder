...
export async function scanProject(repoPath, platforms, options = {}) {
  ...
  for (const filePath of files) {
    try {
      ...
      // Heuristic: Skip files that look like minified or massive auto-generated files
      if (content.length > 100000 && !content.includes('\n')) continue; // Minified
      
      const firstTenLines = lines.slice(0, 10).join('\n').toLowerCase();
      if (firstTenLines.includes('auto-generated') || firstTenLines.includes('generated by')) {
        // Still skip auto-generated files as they shouldn't contain manual secrets
        continue;
      }
